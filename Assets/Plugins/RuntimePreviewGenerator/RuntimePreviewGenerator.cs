...
public static class RuntimePreviewGenerator
{
	...
	private static Vector3 m_previewDirection = new Vector3(1, 0, 0).normalized; //new Vector3(-0.57735f,0, 0); // Normalized (-1,-1,-1)
	...
	private static Color m_backgroundColor = new Color( 0.3f, 0.3f, 0.3f, 0f );
...
#endif
	{
		...
		try
		{
			...
			Quaternion cameraRotation = Quaternion.LookRotation( previewObject.rotation * m_previewDirection, previewObject.forward );
